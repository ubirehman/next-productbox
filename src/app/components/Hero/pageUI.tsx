  ...
  return (
    <div className="flex w-full flex-col items-center justify-center">
      <section className="mt-20 flex max-h-80 w-10/12 flex-col items-center gap-3 text-center leading-[50px] lg:w-6/12 lg:leading-[70px] xl:leading-[100px]">
        ...
        <h3 className="flex h-full px-28 pt-6 text-xl font-light text-gray-400">
          {Constants.PAGES.HOME.TAGLINE}
        </h3>
      </section>
      <section className="mt-20 flex gap-3">
        <Button
          title={
      ...
      <div className="relative -mt-[400px] h-[500px] w-full object-cover">
        <Image
          src={
